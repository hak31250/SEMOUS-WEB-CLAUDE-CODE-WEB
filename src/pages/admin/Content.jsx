...
function PopupModal({ popup, onSave, onClose }) {
  ...
  async function save() {
    ...
    setSaving(true)
    const payload = { ...form, date_debut: form.date_debut || null, date_fin: form.date_fin || null }
    if (popup.id) {
      ...
      <div className="bg-white rounded-2xl w-full max-w-lg p-6 my-4">
        ...
        <div className="flex flex-col gap-4">
          ...
          <div>
            ...
            <textarea className="input-field resize-none" rows={4} value={form.contenu} onChange={e => setForm(f => ({ ...f, contenu: e.target.value }))} />
          </div>
    ...
    <div className="fixed inset-0 bg-black/50 z-50 flex items-center justify-center p-4 overflow-y-auto">
      <div className="bg-white rounded-2xl w-full max-w-2xl p-6 my-4">
        ...
        <div className="flex flex-col gap-4">
          ...
          <div>
            <label className="text-xs font-semibold text-semous-gray-text mb-1.5 block">Meta description</label>
