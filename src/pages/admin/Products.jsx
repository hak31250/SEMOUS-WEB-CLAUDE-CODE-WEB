    ...
    <div>
      <div className="flex items-center justify-between mb-6 flex-wrap gap-3">
        ...
        <div className="flex gap-2">
          <button onClick={() => setAddingCat(v => !v)} className="btn-secondary flex items-center gap-2 text-sm">
              ...
              {editCat === cat.id ? (
                ...
                <>
                  ...
                  {catProducts.length === 0 && (
                    <button onClick={() => deleteCategory(cat.id)} className="text-semous-gray-text hover:text-red-600"><Trash2 size={13} /></button>
                  )}
                </>
              )}
            </div>
            {catProducts.length === 0 && (
              <p className="text-sm text-semous-gray-text italic px-2">Catégorie vide</p>
            )}
  ...
  return (
    <div className="card p-4 flex items-center gap-4">
      ...
      <div className="flex items-center gap-3">
        ...
        <button onClick={onEdit} className="p-1.5 text-semous-gray-text hover:text-semous-black">
          <Pencil size={16} />
        </button>
      </div>
    </div>
